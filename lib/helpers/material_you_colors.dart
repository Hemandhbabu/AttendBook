...
const _platform = MethodChannel('com.example.attendance_app/color');
...
Future<MaterialYouPalette?> getMaterialYouColor() async {
  ...
  try {
    final data = await _platform.invokeMethod('getMaterialYouColors');
...
extension _ColorExtractionExtension on Map<String, dynamic> {
  ...
  MaterialColor getAccent1() {
    return MaterialColor(
      _parseHexString(this['system_accent1_500']),
      <int, Color>{
        0: getColor('system_accent1_0'),
        10: getColor('system_accent1_10'),
        ...
        1000: getColor('system_accent1_1000'),
      },
    );
  }
  ...
  MaterialColor getAccent2() {
    return MaterialColor(
      _parseHexString(this['system_accent2_500']),
      <int, Color>{
        0: getColor('system_accent2_0'),
        10: getColor('system_accent2_10'),
        ...
        1000: getColor('system_accent2_1000'),
      },
    );
  }
  ...
  MaterialColor getAccent3() {
    return MaterialColor(
      _parseHexString(this['system_accent3_500']),
      <int, Color>{
        0: getColor('system_accent3_0'),
        10: getColor('system_accent3_10'),
  ...
  MaterialColor getNeutral1() {
    return MaterialColor(
      _parseHexString(this['system_neutral1_500']),
      <int, Color>{
        0: getColor('system_neutral1_0'),
        10: getColor('system_neutral1_10'),
        ...
        1000: getColor('system_neutral1_1000'),
      },
    );
  }
  ...
  MaterialColor getNeutral2() {
    return MaterialColor(
      _parseHexString(this['system_neutral2_500']),
      <int, Color>{
        0: getColor('system_neutral2_0'),
        10: getColor('system_neutral2_10'),
        ...
        1000: getColor('system_neutral2_1000'),
      },
    );
  }
}
