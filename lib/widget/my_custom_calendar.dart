...
class MyCustomCalendarDatePicker extends StatefulWidget {
  MyCustomCalendarDatePicker({
    Key? key,
  ...
  final List<DateTime> markDateTimes;
...
class _CalendarDatePickerState extends State<MyCustomCalendarDatePicker> {
  ...
  @override
  void didUpdateWidget(MyCustomCalendarDatePicker oldWidget) {
    ...
    switch (_mode) {
      case DatePickerMode.day:
        return _MonthPicker(
          ...
          markDateTimes: widget.markDateTimes,
        );
  ...
  Widget build(BuildContext context) {
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        bool isMark(DateTime dateTime) {
          for (var element in widget.markDateTimes) {
            if (element.day == dateTime.day &&
